...
public class DBUtils {
    ...
    //createConnection database e baglanmak icin. Burada url, username, password u kullanarak database baglaniyoruz
    ...
    // DBUtils.createConnection(); -> to connect to database
